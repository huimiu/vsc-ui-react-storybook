  ...
  const components = [
    {
      ...
      label: "Button",
      file: "button.html",
      description: "Standard, split, and menu buttons",
    },
    {
      id: "context-menu",
      label: "Context Menu",
      file: "context-menu.html",
      description: "Popup menus, menu items, dividers, groups",
    },
    {
      id: "dropdown",
      label: "Dropdown",
      file: "dropdown.html",
      description: "Dropdown, combobox, listbox, and options",
    },
    {
      id: "field",
      label: "Field",
      file: "field.html",
      description: "Label + input wrapper with validation",
    },
    {
      id: "input",
      label: "Input",
      file: "input.html",
      description: "Text input with size and validation variants",
    },
    {
      id: "search-box",
      label: "SearchBox",
      file: "search-box.html",
      description: "Search input with icon and dismiss action",
    },
    {
      id: "textarea",
      label: "Textarea",
    ...
    },
    {
      ...
      label: "Tab",
      file: "tab.html",
      description: "Tabbed navigation and workspace-style tabs",
    },
  ];
  ...
  function buildNav() {
    ...
    components.forEach((c) => {
      ...
      const isComponentPage =
        currentFile.endsWith(".html") && currentFile !== "index.html";
      ...
      (entries) => {
        entries.forEach((entry) => {
          if (entry.isIntersecting) {
            tocList
              .querySelectorAll(".site-toc__link")
              .forEach((l) => l.classList.remove("site-toc__link--active"));
